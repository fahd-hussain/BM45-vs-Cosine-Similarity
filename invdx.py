...
class InvertedIndex:
	...
	# # frequency of word in document which is 'f'
	...
	#
	# # frequency of word in index, i.e. number of documents that contain word which is 'n'
...
class DocumentLengthTable:
	...
	def get_length(self, docid):
		# print(self.table[int(docid)])
		if int(docid) in self.table:
			return self.table[int(docid)]
		else:
